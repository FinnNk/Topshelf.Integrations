...
namespace Topshelf.Quartz.StructureMap.QuartzFactories
{
	public class StructureMapJobFactory : IJobFactory
	{
		...
		private static readonly ILog Log = LogManager.GetLogger(typeof(StructureMapJobFactory));
		...
		/// Instance creation is delegated to the StructureMap container.
		/// </summary>
		/// <remarks>
		...
		public IJob NewJob(TriggerFiredBundle bundle, IScheduler scheduler)
		{
			...
			try
			{
				...
				return _container.GetNestedContainer().GetInstance(jobType) as IJob;
			}
			catch (Exception e)
			{
